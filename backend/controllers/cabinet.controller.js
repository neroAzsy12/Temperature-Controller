...
export const getInitialConfigurableCabinetSettings = async(req, res) => {
    const raspberryPiId = req.params.raspberryDeviceId;
    const rs485DeviceId = req.params.rs485DeviceId;
    ...
    try {
        const response = await axios.get(`${raspberryPiUrl}/temperature-controller/api/v1/${rs485DeviceId}/cabinet/configurable-settings`, {
            params: {
                unit: unit, // include the unit in the query params
            },
        });
